import { ArrowRight, BrainCircuit, ShieldCheck, Swords, Trophy } from "lucide-react";
          ...
          <div className="grid flex-1 items-center gap-10 py-12 lg:grid-cols-[0.95fr_1.05fr]">
            <div>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Link
                  to="/register"
                  className="inline-flex items-center justify-center gap-2 rounded-md bg-pitch-400 px-5 py-3 text-sm font-semibold text-ink-950 transition hover:bg-pitch-300"
                >

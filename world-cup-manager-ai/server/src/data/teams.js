...
const TEAM_CONFIGS = [
  ["A", "MEX", "Mexico", "CONCACAF", 80, "pressing"],
  ["A", "RSA", "South Africa", "CAF", 74, "vertical"],
  ["A", "KOR", "South Korea", "AFC", 79, "pressing"],
  ["A", "CZE", "Czech", "UEFA", 78, "balanced"],
  ["B", "CAN", "Canada", "CONCACAF", 78, "vertical"],
  ["B", "SUI", "Switzerland", "UEFA", 81, "balanced"],
  ["B", "QAT", "Qatar", "AFC", 73, "compact"],
  ["B", "BIH", "Bosnia", "UEFA", 76, "balanced"],
  ["C", "BRA", "Brazil", "CONMEBOL", 88, "possession"],
  ["C", "MAR", "Morocco", "CAF", 81, "compact"],
  ["C", "SCO", "Scotland", "UEFA", 77, "pressing"],
  ["C", "HAI", "Haiti", "CONCACAF", 70, "vertical"],
  ["D", "USA", "United States", "CONCACAF", 79, "pressing"],
  ["D", "PAR", "Paraguay", "CONMEBOL", 77, "compact"],
  ["D", "AUS", "Australia", "AFC", 76, "balanced"],
  ["D", "TUR", "Turkey", "UEFA", 80, "pressing"],
  ["E", "GER", "Germany", "UEFA", 85, "vertical"],
  ["E", "CIV", "Ivory Coast", "CAF", 79, "vertical"],
  ["E", "ECU", "Ecuador", "CONMEBOL", 79, "pressing"],
  ["E", "CUW", "Curacao", "CONCACAF", 71, "compact"],
  ["F", "NED", "Netherlands", "UEFA", 85, "possession"],
  ["F", "JPN", "Japan", "AFC", 79, "pressing"],
  ["F", "TUN", "Tunisia", "CAF", 76, "compact"],
  ["F", "SWE", "Sweden", "UEFA", 80, "balanced"],
  ["G", "BEL", "Belgium", "UEFA", 84, "possession"],
  ["G", "EGY", "Egypt", "CAF", 78, "vertical"],
  ["G", "IRN", "Iran", "AFC", 77, "compact"],
  ["G", "NZL", "New Zealand", "OFC", 70, "balanced"],
  ["H", "ESP", "Spain", "UEFA", 87, "possession"],
  ["H", "URU", "Uruguay", "CONMEBOL", 82, "compact"],
  ["H", "KSA", "Saudi Arabia", "AFC", 75, "vertical"],
  ["H", "CPV", "Cape Verde", "CAF", 73, "pressing"],
  ["I", "FRA", "France", "UEFA", 89, "vertical"],
  ["I", "SEN", "Senegal", "CAF", 80, "vertical"],
  ["I", "NOR", "Norway", "UEFA", 82, "balanced"],
  ["I", "IRQ", "Iraq", "AFC", 73, "compact"],
  ["J", "ARG", "Argentina", "CONMEBOL", 88, "possession"],
  ["J", "ALG", "Algeria", "CAF", 78, "pressing"],
  ["J", "AUT", "Austria", "UEFA", 81, "pressing"],
  ["J", "JOR", "Jordan", "AFC", 72, "compact"],
  ["K", "POR", "Portugal", "UEFA", 86, "possession"],
  ["K", "COL", "Colombia", "CONMEBOL", 82, "vertical"],
  ["K", "UZB", "Uzbekistan", "AFC", 74, "balanced"],
  ["K", "COD", "Congo DC", "CAF", 75, "vertical"],
  ["L", "ENG", "England", "UEFA", 86, "balanced"],
  ["L", "CRO", "Croatia", "UEFA", 82, "possession"],
  ["L", "GHA", "Ghana", "CAF", 77, "vertical"],
  ["L", "PAN", "Panama", "CONCACAF", 72, "compact"],
];
...
function makeProfile([group, code, name, region, overall, styleKey]) {

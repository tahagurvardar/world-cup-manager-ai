...
const gameStateSchema = new mongoose.Schema(
  {
    ...
    boardExpectations: { type: mongoose.Schema.Types.Mixed, default: null },
    lastEvaluation: { type: mongoose.Schema.Types.Mixed, default: null },
    bestEvaluation: { type: mongoose.Schema.Types.Mixed, default: null },
    evaluationHistory: { type: [mongoose.Schema.Types.Mixed], default: [] },
    jobSecurity: { type: Number, default: 70 },
